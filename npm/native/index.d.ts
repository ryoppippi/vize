...
export declare function compileWithTransformPlugins(
  ...
  options?: TransformCompileOptionsNapi | undefined | null,
...
export interface JsFactProviderNapi {
  name: string;
  version: string;
  fingerprint: string;
  visit?: Array<string>;
...
export interface PluginLintOptionsNapi {
  ...
  factProviders?: Array<JsFactProviderNapi>;
}
...
export interface PluginLintOutputNapi {
  ...
  factProviders: Array<ProviderCostNapi>;
}
...
export interface ProviderCostNapi {
  name: string;
  version: string;
  contentKey: string;
