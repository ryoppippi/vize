  ...
  <div class="tokens-view">
    <div class="tokens-header">
      <div class="tokens-header-top">
        ...
        <button class="add-token-btn" type="button" @click="openCreateModal">
          <svg
            fill="none"
            height="16"
            stroke="currentColor"
      ...
      <div class="tokens-toolbar">
        ...
        <input v-model="filter" class="tokens-filter" placeholder="Filter tokens..." type="text">
      </div>
    </div>
    ...
    <div v-else-if="filteredCategories.length === 0" class="tokens-empty">
      ...
      <p v-else>
        No design tokens configured. Add a Style Dictionary config to see tokens here.
      </p>
    </div>
    <template v-else>
