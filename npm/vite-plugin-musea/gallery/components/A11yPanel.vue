...
<template>
  <div class="a11y-panel">
    ...
    <div v-if="!hasRun" class="a11y-empty">
      <p>
        Click "Run Test" to check accessibility with axe-core.
      </p>
      <p class="a11y-hint">
        Tests WCAG 2.0/2.1 AA criteria and best practices.
      </p>
    </div>
        ...
        <div v-else class="a11y-violations">
          ...
          >
            <div class="a11y-violation-header" @click="toggleViolation(violation.id)">
              ...
              <span class="a11y-rule-id">
                {{ violation.id }}
              </span>
              <span class="a11y-node-count">
