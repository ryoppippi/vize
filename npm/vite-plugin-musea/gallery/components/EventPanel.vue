  ...
  <div "event-panel--collapsed": event-panel", isCollapsed { }]" :class="[">
    ...
    <div class="event-header">
      <div class="header-left">
        ...
        <span v-if="currentVariantId" class="current-variant-badge">
          {{ currentVariantId }}
        </span>
    ...
    <div v-if="!isCollapsed" class="event-content">
      ...
      <div v-if="selectedEvent" class="event-detail">
        <div class="detail-header">
          ...
          <button class="detail-close" type="button" @click="selectedEvent = null">
            ×
          </button>
        </div>
