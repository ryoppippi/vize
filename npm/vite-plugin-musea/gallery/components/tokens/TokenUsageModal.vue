        ...
        <div class="modal-panel">
            ...
            <div>
              ...
              <p class="modal-subtitle">
                ...
                <span v-if="token" class="modal-value">
                  &mdash; {{ token.$resolvedValue ?? token.value }}
                </span>
              </p>
            </div>
          ...
          <div class="modal-body">
            <div v-if="token?.$tier === " && primitive" usages.length>
              ...
              <span>
                Components are referencing this primitive value directly. Consider using a semantic token instead.
              </span>
            </div>
              ...
              <div v-for="entry in usages" :key="entry.artPath" class="usage-entry">
                ...
                <div v-if="expandedArts.has(entry.artPath)" class="usage-matches">
                  <div v-for="(match, idx) in entry.matches" :key="idx" class="usage-match-line">
                    <span class="match-line-number">
                      {{ match.line }}
                    </span>
                    <code class="match-line-content">
                      {{ match.lineContent }}
                    </code>
                    <span class="match-property">
                      {{ match.property }}
                    </span>
                  </div>
                </div>
