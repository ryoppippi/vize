          ...
          <form class="modal-form" @submit.prevent="handleSubmit">
            ...
            <template v-if="tier === "primitive"">
              <div class="form-field">
                ...
                <input v-model="tokenValue" class="form-input" placeholder="e.g. #3b82f6, 16px, 400">
              </div>
            </template>
            <template v-else>
              <div class="form-field">
            ...
            <div class="form-field">
              ...
              <select v-model="tokenType" class="form-input form-select">
                ...
                <option v-for="t in TOKEN_TYPES" :key="t" :value="t">
                  {{ t }}
                </option>
              </select>
            </div>
            <div class="form-field">
              ...
              <input v-model="tokenDescription" class="form-input" placeholder="Optional description">
            </div>
