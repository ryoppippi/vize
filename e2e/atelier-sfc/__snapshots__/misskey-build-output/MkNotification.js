...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    withTime: { type: Boolean as PropType<boolean>, required: false, default: false },
  ...
  return (_openBlock(), _createElementBlock("div", {
      class: _normalizeClass(_ctx.$style.root)
        ...
        class: _normalizeClass(_ctx.$style.head)
            ...
            link: "",
            preview: ""
          })) : (['roleAssigned', 'achievementEarned', 'exportCompleted', 'login', 'createToken', 'scheduledNotePosted', 'scheduledNotePostFailed'].includes(__props.notification.type)) ? (_openBlock(), _createBlock(_component_MkAvatar, {
              key: 1,
              class: _normalizeClass(_ctx.$style.icon),
              user: _unref($i),
              link: "",
              preview: ""
            })) : (__props.notification.type === 'reaction:grouped' && __props.notification.note.reactionAcceptance === 'likeOnly') ? (_openBlock(), _createElementBlock("div", {
              key: 2,
              ...
              link: "",
              preview: ""
            })) : ('icon' in __props.notification && __props.notification.icon != null) ? (_openBlock(), _createElementBlock("img", {
              key: 6,
        ...
        class: _normalizeClass(_ctx.$style.tail)
          ...
          class: _normalizeClass(_ctx.$style.header)
                ...
                default: _withCtx(() => [
                  _createVNode(_component_MkUserName, { user: __props.notification.user })
                ]),
                _: 1 /* STABLE */
            ...
            })) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), _createElementVNode("div", null, [ (__props.notification.type === 'reaction' || __props.notification.type === 'reaction:grouped') ? (_openBlock(), _createBlock(_component_MkA, {
              key: 0,
              ...
              _: 1 /* STABLE */
            })) : (__props.notification.type === 'renote' || __props.notification.type === 'renote:grouped') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 1,
                class: _normalizeClass(_ctx.$style.text),
                to: _unref(notePage)(__props.notification.note),
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'reply') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 2,
                class: _normalizeClass(_ctx.$style.text),
                to: _unref(notePage)(__props.notification.note),
                title: _unref(getNoteSummary)(__props.notification.note)
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'mention') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 3,
                class: _normalizeClass(_ctx.$style.text),
                to: _unref(notePage)(__props.notification.note),
                title: _unref(getNoteSummary)(__props.notification.note)
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'quote') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 4,
                class: _normalizeClass(_ctx.$style.text),
                to: _unref(notePage)(__props.notification.note),
                title: _unref(getNoteSummary)(__props.notification.note)
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'note') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 5,
                class: _normalizeClass(_ctx.$style.text),
                to: _unref(notePage)(__props.notification.note),
                title: _unref(getNoteSummary)(__props.notification.note)
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'pollEnded') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 6,
                class: _normalizeClass(_ctx.$style.text),
                to: _unref(notePage)(__props.notification.note),
                title: _unref(getNoteSummary)(__props.notification.note)
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'scheduledNotePosted') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 7,
                class: _normalizeClass(_ctx.$style.text),
                to: _unref(notePage)(__props.notification.note),
                title: _unref(getNoteSummary)(__props.notification.note)
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'roleAssigned') ? (_openBlock(), _createElementBlock("div", {
                key: 8,
                class: _normalizeClass(_ctx.$style.text)
              }, "\n\t\t\t\t" + _toDisplayString(__props.notification.role.name) + "\n\t\t\t", 1 /* TEXT */)) : (__props.notification.type === 'chatRoomInvitationReceived') ? (_openBlock(), _createElementBlock("div", {
                key: 9,
                class: _normalizeClass(_ctx.$style.text)
              }, "\n\t\t\t\t" + _toDisplayString(__props.notification.invitation.room.name) + "\n\t\t\t", 1 /* TEXT */)) : (__props.notification.type === 'achievementEarned') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 10,
                class: _normalizeClass(_ctx.$style.text),
                to: "/my/achievements"
              }, {
                ...
                _: 1 /* STABLE */
              })) : (__props.notification.type === 'createToken') ? (_openBlock(), _createBlock(_component_MkA, {
                key: 12,
                class: _normalizeClass(_ctx.$style.text),
                to: "/settings/apps"
              }, {
                default: _withCtx(() => [
                  _createVNode(_component_Mfm, { text: _unref(i18n).tsx._notification.createTokenDescription({ text: _unref(i18n).ts.manageAccessTokens }) })
                ]),
                _: 1 /* STABLE */
                ...
                style: "opacity: 0.6;"
                  ...
                  class: _normalizeClass(_ctx.$style.text),
                  style: "opacity: 0.6;"
                }, _toDisplayString(_unref(i18n).ts.followRequestAccepted), 3 /* TEXT, CLASS */), (__props.notification.message) ? (_openBlock(), _createElementBlock("div", {
                    key: 0,
                    class: _normalizeClass(_ctx.$style.text),
                    style: "opacity: 0.6; font-style: oblique;"
                  }, [ _createElementVNode("i", {
                      class: _normalizeClass(["ti ti-quote", _ctx.$style.quote])
                    }, null, 2 /* CLASS */), _createVNode(_component_Mfm, {
                      ...
                      class: _normalizeClass(["ti ti-quote", _ctx.$style.quote])
                    }, null, 2 /* CLASS */) ])) : _createCommentVNode("v-if", true) ], 64 /* STABLE_FRAGMENT */)) : (__props.notification.type === 'receiveFollowRequest') ? (_openBlock(), _createElementBlock(_Fragment, { key: 15 }, [ _createElementVNode("span", {
                  class: _normalizeClass(_ctx.$style.text),
                  style: "opacity: 0.6;"
                }, _toDisplayString(_unref(i18n).ts.receiveFollowRequest), 3 /* TEXT, CLASS */), (__props.full && !followRequestDone.value) ? (_openBlock(), _createElementBlock("div", {
                    key: 0,
                ...
                class: _normalizeClass(_ctx.$style.text)
                  ...
                  nowrap: false
                }) ])) : _createCommentVNode("v-if", true), (__props.notification.type === 'reaction:grouped') ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(__props.notification.reactions, (reaction) => {
                return (_openBlock(), _createElementBlock("div", {
                ...
                }), 128 /* KEYED_FRAGMENT */)) ])) : _createCommentVNode("v-if", true) ]) ], 2 /* CLASS */) ], 2 /* CLASS */))
}
}
