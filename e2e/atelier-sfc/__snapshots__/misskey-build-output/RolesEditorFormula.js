...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    modelValue: { type: null as unknown as PropType<Misskey.entities.Role['condFormula']>, required: true },
    draggable: { type: Boolean as PropType<boolean>, required: false },
    dragStartCallback: { type: Object as PropType<(ev: DragEvent) => void>, required: false }
  },
  ...
  return (_openBlock(), _createElementBlock("div", { class: "_gaps" }, [ _createElementVNode("div", {
        class: _normalizeClass(_ctx.$style.header)
          ...
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event: any) => ((typeModelForMkSelect).value = $event))
            ...
            onClick: removeSelf
          }, [ _hoisted_2 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), (v.value.type === 'and' || v.value.type === 'or') ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps"
            ...
            _: 1 /* STABLE */
          })) : (v.value.type === 'followersLessThanOrEq' || v.value.type === 'followersMoreThanOrEq' || v.value.type === 'followingLessThanOrEq' || v.value.type === 'followingMoreThanOrEq' || v.value.type === 'notesLessThanOrEq' || v.value.type === 'notesMoreThanOrEq') ? (_openBlock(), _createBlock(MkInput, {
            key: 3,
            type: "number",
            modelValue: v.value,
            "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event: any) => ((v.value) = $event))
          })) : (v.value.type === 'roleAssignedTo') ? (_openBlock(), _createBlock(MkSelect, {
            key: 4,
