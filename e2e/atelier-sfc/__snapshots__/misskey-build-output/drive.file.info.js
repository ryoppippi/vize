...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", { class: "_gaps" }, [ _createVNode(MkInfo, null, {
        ...
        _: 1 /* STABLE */
            ...
            class: "_gaps"
            ...
            }, [ _createVNode(MkMediaList, { mediaList: [file.value] }) ], 2 /* CLASS */), _createElementVNode("div", {
              class: _normalizeClass(_ctx.$style.fileQuickActionsRoot)
                ...
                }, _toDisplayString(file.value.name), 3 /* TEXT, CLASS */), _createElementVNode("i", {
                ...
                class: _normalizeClass(_ctx.$style.fileQuickActionsOthers)
                ...
                }, [ _hoisted_1 ], 2 /* CLASS */), (file.value.isSensitive) ? (_openBlock(), _createElementBlock("button", {
                    key: 0,
                    class: _normalizeClass(["_button", _ctx.$style.fileQuickActionsOthersButton]),
                  ...
                  class: _normalizeClass(["_button", _ctx.$style.fileQuickActionsOthersButton])
                }, [ _hoisted_4 ], 10 /* CLASS, PROPS */, ["href", "download"]), _createElementVNode("button", {
                ...
                }, [ _hoisted_5 ], 2 /* CLASS */) ], 2 /* CLASS */) ], 2 /* CLASS */), _createElementVNode("div", { class: "_gaps_s" }, [ _createElementVNode("button", {
                ...
                onClick: _cache[6] || (_cache[6] = ($event: any) => (describe()))
                  ...
                  _: 1 /* STABLE */
                }) ], 2 /* CLASS */), _createVNode(MkKeyValue, {
