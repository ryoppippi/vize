...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    connection: { type: null as unknown as PropType<Misskey.IChannelConnection<Misskey.Channels['reversiGame']> | null>, required: false }
  },
  setup(__props) {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      style: "--MI_SPACER-w: 500px;"
        ...
        class: _normalizeClass(["_gaps", _ctx.$style.root])
            ...
            showIndicator: true
          }), _hoisted_1, _createVNode(_component_MkAvatar, {
            style: "width: 32px; height: 32px;",
            user: whiteUser.value,
            showIndicator: true
          }), _createElementVNode("span", null, "(" + _toDisplayString(_unref(i18n).ts._reversi.white) + ")", 1 /* TEXT */) ]), _createElementVNode("div", { style: "overflow: clip; line-height: 28px;" }, [ (!iAmPlayer.value && !game.value.isEnded && turnUser.value) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createVNode(_component_Mfm, {
              ...
              }), _createVNode(_component_MkEllipsis) ])) : _createCommentVNode("v-if", true), ((logPos.value !== game.value.logs.length) && turnUser.value) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createVNode(_component_Mfm, {
                ...
                plain: true,
                customEmojis: turnUser.value.emojis
              }) ])) : _createCommentVNode("v-if", true), (iAmPlayer.value && !game.value.isEnded && !isMyTurn.value) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _toDisplayString(_unref(i18n).ts._reversi.opponentTurn), _createVNode(_component_MkEllipsis), _createElementVNode("span", _hoisted_2, "(" + _toDisplayString(_unref(i18n).tsx.remainingN({ n: opTurnTimerRmain.value })) + ")", 1 /* TEXT */) ])) : _createCommentVNode("v-if", true), (iAmPlayer.value && !game.value.isEnded && isMyTurn.value) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("span", _hoisted_3, _toDisplayString(_unref(i18n).ts._reversi.myTurn), 1 /* TEXT */), _createElementVNode("span", _hoisted_4, "(" + _toDisplayString(_unref(i18n).tsx.remainingN({ n: myTurnTimerRmain.value })) + ")", 1 /* TEXT */) ])) : _createCommentVNode("v-if", true), (game.value.isEnded && logPos.value == game.value.logs.length) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ (game.value.winner) ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [ _createVNode(_component_Mfm, {
                    key: 'won',
                  ...
                  }), (game.value.surrenderedUserId != null) ? (_openBlock(), _createElementBlock("span", { key: 0 }, " (" + _toDisplayString(_unref(i18n).ts._reversi.surrendered) + ")", 1 /* TEXT */)) : _createCommentVNode("v-if", true), (game.value.timeoutUserId != null) ? (_openBlock(), _createElementBlock("span", { key: 0 }, " (" + _toDisplayString(_unref(i18n).ts._reversi.timeout) + ")", 1 /* TEXT */)) : _createCommentVNode("v-if", true) ], 64 /* STABLE_FRAGMENT */)) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [ _toDisplayString(_unref(i18n).ts._reversi.drawn) ], 64 /* STABLE_FRAGMENT */)) ])) : _createCommentVNode("v-if", true) ]), _createElementVNode("div", { class: "_woodenFrame" }, [ _createElementVNode("div", {
            class: _normalizeClass(_ctx.$style.boardInner)
                ...
                class: _normalizeClass(_ctx.$style.labelsX)
                  ...
                  }, _toDisplayString(String.fromCharCode(64 + i)), 3 /* TEXT, CLASS */))
                ...
                }), 128 /* KEYED_FRAGMENT */)) ], 6 /* CLASS, STYLE */), (showBoardLabels.value) ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
                  class: _normalizeClass(_ctx.$style.labelsY)
                }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(game.value.map.length, (i) => {
                    return (_openBlock(), _createElementBlock("div", {
                ...
                }), 128 /* KEYED_FRAGMENT */)) ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ]), (game.value.isEnded) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
          ...
          class: "_panel",
          style: "padding: 16px;"
        }, [ _createElementVNode("div", null, [ _createElementVNode("b", null, _toDisplayString(_unref(i18n).tsx._reversi.turnCount({ count: logPos.value })), 1 /* TEXT */), _createTextVNode(" "), _createTextVNode(_toDisplayString(_unref(i18n).ts._reversi.black), 1 /* TEXT */), _createTextVNode(":"), _createTextVNode(_toDisplayString(engine.value.blackCount), 1 /* TEXT */), _createTextVNode(" "), _createTextVNode(_toDisplayString(_unref(i18n).ts._reversi.white), 1 /* TEXT */), _createTextVNode(":"), _createTextVNode(_toDisplayString(engine.value.whiteCount), 1 /* TEXT */), _createTextVNode(" "), _createTextVNode(_toDisplayString(_unref(i18n).ts._reversi.total), 1 /* TEXT */), _createTextVNode(":"), _createTextVNode(_toDisplayString(engine.value.blackCount + engine.value.whiteCount), 1 /* TEXT */), _createTextVNode("\n\t\t\t") ]), _createElementVNode("div", null, [ _createElementVNode("div", { style: "display: flex; align-items: center;" }, [ _createElementVNode("span", _hoisted_10, "(" + _toDisplayString(_unref(i18n).ts._reversi.black) + ")", 1 /* TEXT */), _createVNode(_component_MkAvatar, {
                style: "width: 32px; height: 32px; margin-right: 8px;",
                user: blackUser.value,
                showIndicator: true
              }), _createVNode(_component_MkA, { to: _unref(userPage)(blackUser.value) }, {
                default: _withCtx(() => [
                  _createVNode(_component_MkUserName, { user: blackUser.value })
                ]),
                _: 1 /* STABLE */
              }) ]), _hoisted_11, _createElementVNode("div", { style: "display: flex; align-items: center;" }, [ _createElementVNode("span", _hoisted_12, "(" + _toDisplayString(_unref(i18n).ts._reversi.white) + ")", 1 /* TEXT */), _createVNode(_component_MkAvatar, {
                style: "width: 32px; height: 32px; margin-right: 8px;",
                user: whiteUser.value,
                showIndicator: true
              }), _createVNode(_component_MkA, { to: _unref(userPage)(whiteUser.value) }, {
                default: _withCtx(() => [
                  _createVNode(_component_MkUserName, { user: whiteUser.value })
                ]),
                _: 1 /* STABLE */
              }) ]) ]), _createElementVNode("div", null, [ (game.value.isLlotheo) ? (_openBlock(), _createElementBlock("p", { key: 0 }, _toDisplayString(_unref(i18n).ts._reversi.isLlotheo), 1 /* TEXT */)) : _createCommentVNode("v-if", true), (game.value.loopedBoard) ? (_openBlock(), _createElementBlock("p", { key: 0 }, _toDisplayString(_unref(i18n).ts._reversi.loopedMap), 1 /* TEXT */)) : _createCommentVNode("v-if", true), (game.value.canPutEverywhere) ? (_openBlock(), _createElementBlock("p", { key: 0 }, _toDisplayString(_unref(i18n).ts._reversi.canPutEverywhere), 1 /* TEXT */)) : _createCommentVNode("v-if", true) ]) ]), _createVNode(MkFolder, null, {
          label: _withCtx(() => [
