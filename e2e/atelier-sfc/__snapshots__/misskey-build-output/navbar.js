...
export default /*@__PURE__*/_defineComponent({
  __name: 'navbar',
  props: {
    showWidgetButton: { type: Boolean as PropType<boolean>, required: false },
      ...
      class: _normalizeClass([_ctx.$style.root, { [_ctx.$style.iconOnly]: iconOnly.value }])
        ...
        class: _normalizeClass(_ctx.$style.body)
          ...
          class: _normalizeClass(_ctx.$style.top)
            ...
            onClick: _cache[0] || (_cache[0] = (...args) => (openInstanceMenu && openInstanceMenu(...args)))
            ...
            }, null, 10 /* CLASS, PROPS */, ["src"]) ], 2 /* CLASS */), (!iconOnly.value) ? (_openBlock(), _createElementBlock("button", {
              key: 0,
              ...
              onClick: toggleRealtimeMode
                ...
                })) ])) : _createCommentVNode("v-if", true), (!iconOnly.value && __props.showWidgetButton) ? (_openBlock(), _createElementBlock("button", {
              key: 0,
              class: _normalizeClass(["_button", [_ctx.$style.widget]]),
              onClick: _cache[1] || (_cache[1] = () => emit('widgetButtonClick'))
            }, [ _hoisted_1 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), _createElementVNode("div", {
          class: _normalizeClass(_ctx.$style.middle)
            ...
            default: _withCtx(() => [
              ...
              }, _toDisplayString(_unref(i18n).ts.timeline), 3 /* TEXT, CLASS */)
            ]),
            _: 1 /* STABLE */
          }), (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_unref(prefer).r.menu.value, (item) => {
            return (_openBlock(), _createElementBlock(_Fragment, null, [
              (item === '-')
                ...
                : (_unref(navbarItemDef)[item] && (_unref(navbarItemDef)[item].show == null || _unref(navbarItemDef)[item].show.value !== false))
                  ? (_openBlock(), _createBlock(_resolveDynamicComponent(_unref(navbarItemDef)[item].to ? 'MkA' : 'button'), _mergeProps(_toHandlers(($event: any) => (_unref(navbarItemDef)[item].action ? { click: _unref(navbarItemDef)[item].action } : {}), true), {
                    key: 1,
                    ...
                    default: _withCtx(() => [
                      ...
                      _createElementVNode("span", {
                        class: _normalizeClass(_ctx.$style.itemText)
                      }, _toDisplayString(_unref(navbarItemDef)[item].title), 3 /* TEXT, CLASS */),
            ...
            class: _normalizeClass(_ctx.$style.divider)
          }, null, 2 /* CLASS */), (_unref($i) != null && (_unref($i).isAdmin || _unref($i).isModerator)) ? (_openBlock(), _createBlock(_component_MkA, {
              key: 0,
              class: _normalizeClass(_ctx.$style.item),
              activeClass: _ctx.$style.active,
              to: "/admin"
              ...
              default: _withCtx(() => [
                ...
                _createElementVNode("span", {
                  class: _normalizeClass(_ctx.$style.itemText)
                }, _toDisplayString(_unref(i18n).ts.controlPanel), 3 /* TEXT, CLASS */)
              ]),
              _: 1 /* STABLE */
            ...
            onClick: more
              ...
              class: _normalizeClass(_ctx.$style.itemText)
            }, _toDisplayString(_unref(i18n).ts.more), 3 /* TEXT, CLASS */), (otherMenuItemIndicated.value) ? (_openBlock(), _createElementBlock("span", {
                key: 0,
                class: _normalizeClass(["_blink", _ctx.$style.itemIndicator])
              }, [ _hoisted_2 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), _createVNode(_component_MkA, {
            class: _normalizeClass(_ctx.$style.item),
            activeClass: _ctx.$style.active,
            to: "/settings"
          }, {
            default: _withCtx(() => [
              ...
              _createElementVNode("span", {
                class: _normalizeClass(_ctx.$style.itemText)
              }, _toDisplayString(_unref(i18n).ts.settings), 3 /* TEXT, CLASS */)
            ]),
            _: 1 /* STABLE */
          }) ], 2 /* CLASS */), _createElementVNode("div", {
          class: _normalizeClass(_ctx.$style.bottom)
        }, [ (iconOnly.value && __props.showWidgetButton) ? (_openBlock(), _createElementBlock("button", {
              key: 0,
              class: _normalizeClass(["_button", [_ctx.$style.widget]]),
              onClick: _cache[2] || (_cache[2] = () => emit('widgetButtonClick'))
            }, [ _hoisted_3 ])) : _createCommentVNode("v-if", true), (iconOnly.value) ? (_openBlock(), _createElementBlock("button", {
              key: 0,
              class: _normalizeClass(["_button", [_ctx.$style.realtimeMode, _unref(store).r.realtimeMode.value ? _ctx.$style.on : null]]),
              onClick: toggleRealtimeMode
            }, [ (_unref(store).r.realtimeMode.value) ? (_openBlock(), _createElementBlock("i", {
            ...
            }, _toDisplayString(_unref(i18n).ts.note), 3 /* TEXT, CLASS */) ], 2 /* CLASS */), (_unref($i) != null) ? (_openBlock(), _createElementBlock("button", {
              key: 0,
          ...
          class: _normalizeClass(_ctx.$style.subButtons)
            ...
            class: _normalizeClass(_ctx.$style.subButton)
            ...
            }, [ _createElementVNode("g", { transform: "matrix(0.333333,0,0,0.222222,0.000895785,21.3333)" }, [ _hoisted_4 ]) ], 2 /* CLASS */), _createElementVNode("button", {
              ...
              onClick: menuEdit
              ...
              }, null, 2 /* CLASS */) ], 2 /* CLASS */) ], 2 /* CLASS */), (!props.asDrawer) ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [ _createElementVNode("div", {
                ...
                class: _normalizeClass(_ctx.$style.subButton)
                  ...
                  viewBox: "0 0 16 64",
                  class: _normalizeClass(_ctx.$style.subButtonShape)
                }, [ _createElementVNode("g", { transform: "matrix(0.333333,0,0,0.222222,0.000895785,21.3333)" }, [ _hoisted_5 ]) ], 2 /* CLASS */), _createElementVNode("button", {
                  class: _normalizeClass(["_button", _ctx.$style.subButtonClickable]),
                  onClick: toggleIconOnly
                    ...
                    })) ], 2 /* CLASS */) ], 2 /* CLASS */) ], 64 /* STABLE_FRAGMENT */)) : _createCommentVNode("v-if", true) ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */))
}
}
