...
const _hoisted_1 = /*#__PURE__*/ _createElementVNode("i", { class: "ti ti-mail", style: "margin-right: 8px;" })
...
return (_ctx: any,_cache: any) => {
  return (_openBlock(), _createBlock(XColumn, {
      ...
      header: _withCtx(() => [
        _hoisted_1,
        _createTextVNode(_toDisplayString(__props.column.name || _unref(i18n).ts._deck._columns.direct), 1 /* TEXT */)
      ]),
      default: _withCtx(() => [
