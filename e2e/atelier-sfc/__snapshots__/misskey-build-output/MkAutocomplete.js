...
export default /*@__PURE__*/Object.assign(__default__, {
  ...
  props: {
    type: { type: null as unknown as PropType<T>, required: true },
    q: { type: null as unknown as PropType<CompleteInfo[T]['query']>, required: true },
    textarea: { type: null as unknown as PropType<(HTMLTextAreaElement | HTMLInputElement) & HTMLElement>, required: true },
      ...
      onContextmenu: _cache[0] || (_cache[0] = _withModifiers(() => {}, ["prevent"]))
          ...
          class: _normalizeClass(_ctx.$style.list)
            ...
            return (_openBlock(), _createElementBlock("li", { tabindex: "-1", class: _normalizeClass(_ctx.$style.item), onClick: _cache[1] || (_cache[1] = ($event: any) => (complete(_ctx.type, user))), onKeydown: onKeydown }, [
              ...
              _createElementVNode("span", null, "@" + _toDisplayString(_ctx.acct(user)), 1 /* TEXT */)
            ...
            onKeydown: onKeydown
          }, _toDisplayString(_ctx.i18n.ts.selectUser), 35 /* TEXT, CLASS, NEED_HYDRATION */) ])) : (_ctx.type === 'hashtag' && hashtags.value.length > 0) ? (_openBlock(), _createElementBlock("ol", {
            key: 1,
            ref: "suggests",
            class: _normalizeClass(_ctx.$style.list)
              ...
              return (_openBlock(), _createElementBlock("li", {
                ...
                (_ctx.q != null && typeof _ctx.q === 'string')
                  ? (_openBlock(), _createElementBlock("span", {
                    ...
                    innerHTML: _ctx.sanitizeHtml(emoji.name.replace(_ctx.q, `<b>${_ctx.q}</b>`))
                  }))
                  : (_openBlock(), _createElementBlock("span", {
                    key: 1,
            ...
            }), 256 /* UNKEYED_FRAGMENT */)) ])) : _createCommentVNode("v-if", true) ], 38 /* CLASS, STYLE, NEED_HYDRATION */))
}
}
