...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    initialFolder: { type: null as unknown as PropType<Misskey.entities.DriveFolder['id'] | null>, required: false },
    multiple: { type: Boolean as PropType<boolean>, required: true }
  },
  emits: ["done", "closed"],
