        ...
        class: _normalizeClass([_ctx.$style.root])
          ...
          class: _normalizeClass([_ctx.$style.upper, { [_ctx.$style.slim]: narrow.value, [_ctx.$style.thin]: _unref(thin_) }])
              ...
              onClick: openAccountMenu
                ...
                user: _unref($i)
              }) ])) : (!_unref(thin_) && narrow.value && !hideTitle.value) ? (_openBlock(), _createElementBlock("div", {
                key: 1,
                class: _normalizeClass(_ctx.$style.buttons)
                  ...
                  onClick: top
                      ...
                      class: _normalizeClass(_ctx.$style.titleAvatarContainer)
                        ...
                        indicator: ""
                      }) ])) : (pageMetadata.value.icon) ? (_openBlock(), _createElementBlock("i", {
                        key: 1,
                    ...
                    class: _normalizeClass(["_nowrap", _ctx.$style.title])
                        ...
                        nowrap: true
                      })) : (pageMetadata.value.title) ? (_openBlock(), _createElementBlock("div", {
                          key: 1,
                          class: "_nowrap"
                      ...
                      }, "\n\t\t\t\t\t\t" + _toDisplayString(pageMetadata.value.subtitle) + "\n\t\t\t\t\t", 1 /* TEXT */)) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ])) : _createCommentVNode("v-if", true), (!narrow.value || hideTitle.value) ? (_openBlock(), _createBlock(XTabs, {
                  key: 0,
                ...
                })) : _createCommentVNode("v-if", true) ], 64 /* STABLE_FRAGMENT */)) : _createCommentVNode("v-if", true), ((!_unref(thin_) && narrow.value && !hideTitle.value) || (_ctx.actions && _ctx.actions.length > 0)) ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: _normalizeClass(_ctx.$style.buttons)
            }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.actions, (action) => {
                return (_openBlock(), _createElementBlock("button", { class: "_button", class: _normalizeClass([_ctx.$style.button, { [_ctx.$style.highlighted]: action.highlighted }]), onClick: _cache[1] || (_cache[1] = _withModifiers(($event: any) => (action.handler), ["stop"])), onTouchstart: preventDrag }, [
