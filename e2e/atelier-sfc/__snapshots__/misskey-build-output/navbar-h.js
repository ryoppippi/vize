...
export default /*@__PURE__*/_defineComponent({
  __name: 'navbar-h',
  props: {
    acrylic: { type: Boolean as PropType<boolean>, required: false }
  },
  setup(__props) {
      ...
      class: _normalizeClass([_ctx.$style.root, __props.acrylic ? _ctx.$style.acrylic : null])
        ...
        class: _normalizeClass(_ctx.$style.body)
            ...
            onClick: _cache[0] || (_cache[0] = (...args) => (openInstanceMenu && openInstanceMenu(...args)))
              ...
              draggable: "false"
            }, null, 10 /* CLASS, PROPS */, ["src"]) ], 2 /* CLASS */), _createVNode(_component_MkA, {
            ...
            _: 1 /* STABLE */
          }), (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(menu.value, (item) => {
            ...
            class: _normalizeClass(_ctx.$style.divider)
          }, null, 2 /* CLASS */), (_unref($i) && (_unref($i).isAdmin || _unref($i).isModerator)) ? (_openBlock(), _createBlock(_component_MkA, {
              key: 0,
              class: "item",
              activeClass: _ctx.$style.active,
              to: "/admin",
            ...
            }, null, 2 /* CLASS */), (otherNavItemIndicated.value) ? (_openBlock(), _createElementBlock("span", {
                key: 0,
                class: _normalizeClass(["_blink", _ctx.$style.indicator])
              }, [ _hoisted_2 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ]), _createElementVNode("div", {
          class: _normalizeClass(_ctx.$style.right)
            ...
            _: 1 /* STABLE */
          }), (_unref($i)) ? (_openBlock(), _createElementBlock("button", {
              key: 0,
