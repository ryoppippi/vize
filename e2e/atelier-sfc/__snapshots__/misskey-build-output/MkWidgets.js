...
export default /*@__PURE__*/_defineComponent({
  __name: 'MkWidgets',
  props: {
    widgets: { type: Array as PropType<Widget[]>, required: true },
    edit: { type: Boolean as PropType<boolean>, required: true }
  },
  emits: ["updateWidgets", "addWidget", "removeWidget", "updateWidget", "id", "data", "exit"],
  ...
  return (_openBlock(), _createElementBlock("div", {
      class: _normalizeClass(["_gaps_s", _ctx.$style.root])
            ...
            class: _normalizeClass(_ctx.$style.editHeader)
              ...
              _: 1 /* STABLE */
            }) ], 2 /* CLASS */), _createVNode(MkDraggable, {
            ...
            _: 1 /* STABLE */
          }) ], 64 /* STABLE_FRAGMENT */)) : _createCommentVNode("v-if", true), (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_widgets.value, (widget) => {
        return (_openBlock(), _createBlock(_resolveDynamicComponent(`widget-${widget.name}`), {
          ...
          widget: widget,
          onUpdateProps: _cache[6] || (_cache[6] = ($event: any) => (updateWidget(widget.id, $event))),
          onContextmenu: _cache[7] || (_cache[7] = _withModifiers(($event: any) => (onContextmenu(widget, $event)), ["stop"]))
        }, null, 522 /* CLASS, PROPS, NEED_PATCH */, ["is", "widget"]))
