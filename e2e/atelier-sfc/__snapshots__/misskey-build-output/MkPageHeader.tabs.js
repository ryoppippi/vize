...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    tabs: { type: Array as PropType<Tab[]>, required: false, default: () => ([] as Tab[]) },
    tab: { type: String as PropType<string>, required: false },
    rootEl: { type: null as unknown as PropType<HTMLElement | null>, required: false }
  },
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      onWheel: onTabWheel
        ...
        class: _normalizeClass(_ctx.$style.tabsInner)
          ...
          return (_openBlock(), _createElementBlock("button", { ref: (el) => _unref(tabRefs)[t.key] = el, class: "_button", class: _normalizeClass([_ctx.$style.tab, {
              ...
              (!t.iconOnly || (!_unref(prefer).s.animation && t.key === __props.tab))
                ...
                : (_openBlock(), _createBlock(_Transition, {
                  ...
                  default: _withCtx(() => [
                    ...
                    }, _toDisplayString(t.title), 3 /* TEXT, CLASS */), [
        ...
        }), 256 /* UNKEYED_FRAGMENT */)) ], 2 /* CLASS */), _createElementVNode("div", {
        ref: tabHighlightEl,
        class: _normalizeClass([_ctx.$style.tabHighlight, { [_ctx.$style.animate]: _unref(prefer).s.animation }])
      }, null, 2 /* CLASS */) ], 38 /* CLASS, STYLE, NEED_HYDRATION */))
}
}
