...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    initialTab: { type: String as PropType<string>, required: false, default: 'replies' }
  },
  setup(__props) {
  ...
  return (!muted.value && !hideByPlugin.value && !isDeleted.value)
      ? (_openBlock(), _createElementBlock("div", {
        ...
        tabindex: "0"
          ...
          })) : _createCommentVNode("v-if", true), (_unref(isRenote)) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            class: _normalizeClass(_ctx.$style.renote)
              ...
              class: _normalizeClass(_ctx.$style.renoteText)
                ...
                user: _withCtx(() => [
                  _createVNode(_component_MkA, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_MkUserName, { user: _unref(note).user })
                    ]),
                    _: 1 /* STABLE */
                  })
                ]),
              ...
              class: _normalizeClass(_ctx.$style.renoteInfo)
                ...
                onMousedown: _cache[0] || (_cache[0] = _withModifiers(($event: any) => (showRenoteMenu()), ["prevent"]))
                  ...
                  })) : _createCommentVNode("v-if", true), _createVNode(_component_MkTime, { time: _unref(note).createdAt }) ], 34 /* CLASS, NEED_HYDRATION */), (_unref(note).visibility !== 'public') ? (_openBlock(), _createElementBlock("span", {
                  key: 0,
                ...
                }, [ _hoisted_2 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ])) : _createCommentVNode("v-if", true), (_unref(isRenote) && _unref(note).renote == null) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            class: _normalizeClass(_ctx.$style.deleted)
          }, "\n\t\t" + _toDisplayString(_unref(i18n).ts.deletedNote) + "\n\t", 1 /* TEXT */)) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [ _createElementVNode("article", {
              ...
              onContextmenu: _withModifiers(onContextmenu, ["stop"])
                ...
                class: _normalizeClass(_ctx.$style.noteHeader)
                  ...
                  class: _normalizeClass(_ctx.$style.noteHeaderBody)
                      ...
                      _: 1 /* STABLE */
                    }), (_unref(appearNote).user.isBot) ? (_openBlock(), _createElementBlock("span", {
                        key: 0,
                      ...
                      class: _normalizeClass(_ctx.$style.noteHeaderInfo)
                          ...
                          style: "margin-left: 0.5em;",
                          title: _unref(i18n).ts._visibility['disableFederation']
                        }, [ _hoisted_3 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ]), _createElementVNode("div", {
                    class: _normalizeClass(_ctx.$style.noteHeaderUsernameAndBadgeRoles)
                  }, [ _createElementVNode("div", {
                      class: _normalizeClass(_ctx.$style.noteHeaderUsername)
                    }, [ _createVNode(_component_MkAcct, { user: _unref(appearNote).user }) ], 2 /* CLASS */), (_unref(appearNote).user.badgeRoles) ? (_openBlock(), _createElementBlock("div", {
                        key: 0,
                        ...
                        }), 128 /* KEYED_FRAGMENT */)) ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), (_unref(showTicker)) ? (_openBlock(), _createBlock(MkInstanceTicker, {
                      key: 0,
                      host: _unref(appearNote).user.host,
                      instance: _unref(appearNote).user.instance
                    })) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ], 2 /* CLASS */), _createElementVNode("div", {
                class: _normalizeClass(_ctx.$style.noteContent)
                    ...
                    class: _normalizeClass(_ctx.$style.cw)
                    ...
                    }) ])) : _createCommentVNode("v-if", true), _withDirectives(_createElementVNode("div", null, [ (_unref(appearNote).isHidden) ? (_openBlock(), _createElementBlock("span", {
                      key: 0,
                      style: "opacity: 0.5"
                      ...
                      _: 1 /* STABLE */
                    })) : _createCommentVNode("v-if", true), (_unref(appearNote).text) ? (_openBlock(), _createBlock(_component_Mfm, {
                      key: 0,
                      ...
                      enableEmojiMenuReaction: true,
                      class: "_selectable"
                    })) : _createCommentVNode("v-if", true), (_unref(appearNote).renote != null) ? (_openBlock(), _createElementBlock("a", {
                      key: 0,
                      ...
                      class: _normalizeClass(_ctx.$style.translation)
                          ...
                          mini: ""
                              ...
                              emojiUrls: _unref(appearNote).emojis,
                              class: "_selectable"
                            }) ])) : _createCommentVNode("v-if", true) ])) : _createCommentVNode("v-if", true), (_unref(appearNote).files && _unref(appearNote).files.length > 0) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createVNode(MkMediaList, {
                        ref: galleryEl,
                        mediaList: _unref(appearNote).files
                      }) ])) : _createCommentVNode("v-if", true), (_unref(appearNote).poll) ? (_openBlock(), _createBlock(MkPoll, {
                      key: 0,
                    ...
                    })) : _createCommentVNode("v-if", true), (_unref(isEnabledUrlPreview)) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_unref(urls), (url) => {
                      ...
                      }) ])) : _createCommentVNode("v-if", true) ], 512 /* NEED_PATCH */), [ [_vShow, _unref(appearNote).cw == null || showContent.value] ]), (_unref(appearNote).channel && !inChannel) ? (_openBlock(), _createBlock(_component_MkA, {
                    key: 0,
                    ...
                    _: 1 /* STABLE */
                  })) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), _createElementVNode("footer", null, [ _createElementVNode("div", {
                  class: _normalizeClass(_ctx.$style.noteFooterInfo)
                    ...
                    _: 1 /* STABLE */
                  }) ], 2 /* CLASS */), (_unref(appearNote).reactionAcceptance !== 'likeOnly') ? (_openBlock(), _createBlock(MkReactionsViewer, {
                    key: 0,
                    style: "margin-top: 6px;",
                  ...
                  onClick: _cache[2] || (_cache[2] = ($event: any) => (reply()))
                    ...
                    }, _toDisplayString(number(_unref(appearNote).repliesCount)), 1 /* TEXT */)) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), (canRenote.value) ? (_openBlock(), _createElementBlock("button", {
                    key: 0,
                    ref: "renoteButton",
                    class: _normalizeClass(["_button", _ctx.$style.noteFooterButton]),
                  ...
                  onClick: _cache[4] || (_cache[4] = ($event: any) => (toggleReact()))
                      ...
                      key: 0,
                      class: _normalizeClass(_ctx.$style.noteFooterButtonCount)
                    }, _toDisplayString(number(_unref($appearNote).reactionCount)), 1 /* TEXT */)) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), (_unref(prefer).s.showClipButtonInNoteFooter) ? (_openBlock(), _createElementBlock("button", {
                    key: 0,
                    ref: "clipButton",
                    class: _normalizeClass(["_button", _ctx.$style.noteFooterButton]),
                ...
                }, [ _hoisted_10 ], 34 /* CLASS, NEED_HYDRATION */) ]) ], 34 /* CLASS, NEED_HYDRATION */), _createElementVNode("div", {
              class: _normalizeClass(_ctx.$style.tabs)
              ...
              }, [ _hoisted_11, _createTextVNode(" "), _createTextVNode(_toDisplayString(_unref(i18n).ts.replies), 1 /* TEXT */) ], 2 /* CLASS */), _createElementVNode("button", {
              ...
              }, [ _hoisted_12, _createTextVNode(" "), _createTextVNode(_toDisplayString(_unref(i18n).ts.renotes), 1 /* TEXT */) ], 2 /* CLASS */), _createElementVNode("button", {
                ...
                onClick: _cache[9] || (_cache[9] = ($event: any) => (tab.value = 'reactions'))
              }, [ _hoisted_13, _createTextVNode(" "), _createTextVNode(_toDisplayString(_unref(i18n).ts.reactions), 1 /* TEXT */) ], 2 /* CLASS */) ], 2 /* CLASS */), _createElementVNode("div", null, [ (tab.value === 'replies') ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ (!repliesLoaded.value) ? (_openBlock(), _createElementBlock("div", {
                      key: 0,
                      style: "padding: 16px"
                    }, [ _createVNode(MkButton, {
                        style: "margin: 0 auto;",
                    ...
                    return (_openBlock(), _createBlock(MkNoteSub, {
                      ...
                      detail: true
                    }, null, 10 /* CLASS, PROPS */, ["note", "detail"]))
                    ...
                    class: _normalizeClass(_ctx.$style.tab_renotes)
                      ...
                      _: 1 /* STABLE */
                    }) ])) : (tab.value === 'reactions') ? (_openBlock(), _createElementBlock("div", {
                    key: 2,
                    class: _normalizeClass(_ctx.$style.tab_reactions)
                      ...
                      class: _normalizeClass(_ctx.$style.reactionTabs)
                        ...
                        return (_openBlock(), _createElementBlock("button", {
                          key: reaction,
                          class: _normalizeClass([_ctx.$style.reactionTab, { [_ctx.$style.reactionTabActive]: reactionTabType.value === reaction }]),
                          class: "_button",
                          onClick: _cache[10] || (_cache[10] = ($event: any) => (reactionTabType.value = reaction))
                        }, [
                          _createVNode(MkReactionIcon, { reaction: reaction }),
                          _createElementVNode("span", _hoisted_14, _toDisplayString(_unref($appearNote).reactions[reaction]), 1 /* TEXT */)
                        ], 2 /* CLASS */))
                      }), 128 /* KEYED_FRAGMENT */)) ], 2 /* CLASS */), (reactionTabType.value) ? (_openBlock(), _createBlock(MkPagination, {
                        ...
                        _: 1 /* STABLE */
                      })) : _createCommentVNode("v-if", true) ])) : _createCommentVNode("v-if", true) ]) ], 64 /* STABLE_FRAGMENT */)) ]))
      : (muted.value)
        ? (_openBlock(), _createElementBlock("div", {
          key: 1,
          ...
          onClick: _cache[11] || (_cache[11] = ($event: any) => (muted.value = false))
            ...
            name: _withCtx(() => [
              _createVNode(_component_MkA, { to: _unref(userPage)(_unref(appearNote).user) }, {
                default: _withCtx(() => [
                  _createVNode(_component_MkUserName, { user: _unref(appearNote).user })
                ]),
                _: 1 /* STABLE */
              })
            ]),
