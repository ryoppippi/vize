...
export default /*@__PURE__*/_defineComponent({
  __name: 'MkDrive',
  props: {
    initialFolder: { type: null as unknown as PropType<Misskey.entities.DriveFolder | Misskey.entities.DriveFolder['id'] | null>, required: false, default: null },
    type: { type: String as PropType<string>, required: false },
    multiple: { type: Boolean as PropType<boolean>, required: false, default: false },
    select: { type: String as PropType<'file' | 'folder' | null>, required: false, default: null },
    forceDisableInfiniteScroll: { type: Boolean as PropType<boolean>, required: false, default: false }
  },
                  ...
                  return (_openBlock(), _createBlock(_component_MkStickyContainer, { key: `${item.date.getFullYear()}/${item.date.getMonth() + 1}` }, [
                    _createElementVNode("div", {
                      ...
                      _createElementVNode("span", null, [
                        _hoisted_8,
                        _createTextVNode(" "),
                        _createTextVNode(_toDisplayString(item.date.getFullYear()), 1 /* TEXT */),
                        _createTextVNode("/"),
                        _createTextVNode(_toDisplayString(item.date.getMonth() + 1), 1 /* TEXT */)
                      ])
                    ], 2 /* CLASS */),
