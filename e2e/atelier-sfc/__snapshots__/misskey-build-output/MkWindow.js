...
export default /*@__PURE__*/_defineComponent({
  __name: 'MkWindow',
  props: {
    initialWidth: { type: Number as PropType<number>, required: true, default: 400 },
    initialHeight: { type: Number as PropType<number | null>, required: true, default: null },
    canResize: { type: Boolean as PropType<boolean>, required: false, default: false },
    closeButton: { type: Boolean as PropType<boolean>, required: false, default: true },
    mini: { type: Boolean as PropType<boolean>, required: false, default: false },
    front: { type: Boolean as PropType<boolean>, required: false, default: false },
    contextmenu: { type: Array as PropType<MenuItem[] | null>, required: false, default: null },
    buttonsLeft: { type: Array as PropType<WindowButton[]>, required: false, default: () => [] },
    buttonsRight: { type: Array as PropType<WindowButton[]>, required: false, default: () => [] }
  },
  emits: ["closed"],
                  ...
                  (!minimized.value)
                    ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(__props.buttonsLeft, (button) => {
                        return (_openBlock(), _createElementBlock("button", { class: "_button", class: _normalizeClass([_ctx.$style.headerButton, { [_ctx.$style.highlighted]: button.highlighted }]), onClick: _cache[1] || (_cache[1] = ($event: any) => (button.onClick)) }, [
                  ...
                  (!minimized.value)
                    ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(__props.buttonsRight, (button) => {
                        return (_openBlock(), _createElementBlock("button", { class: "_button", class: _normalizeClass([_ctx.$style.headerButton, { [_ctx.$style.highlighted]: button.highlighted }]), onClick: _cache[2] || (_cache[2] = ($event: any) => (button.onClick)) }, [
                          _createElementVNode("i", {
                            class: _normalizeClass(button.icon)
                          }, null, 2 /* CLASS */)
                        ], 2 /* CLASS */))
