...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      onDrop: _withModifiers(onDrop, ["stop"])
        ...
        class: _normalizeClass(_ctx.$style.header)
          ...
          class: _normalizeClass(_ctx.$style.headerLeft)
            ...
            }, null, 10 /* CLASS, PROPS */, ["src"]) ], 512 /* NEED_PATCH */) ], 2 /* CLASS */), _createElementVNode("div", {
          class: _normalizeClass(_ctx.$style.headerRight)
                  ...
                  }, _toDisplayString(_unref(i18n).ts._visibility[visibility.value]), 3 /* TEXT, CLASS */) ])) : (_openBlock(), _createElementBlock("button", {
                  key: 1,
                  class: _normalizeClass(["_button", [_ctx.$style.headerRightItem, _ctx.$style.visibility]]),
                  disabled: ""
                }, [ _createElementVNode("span", null, [ _hoisted_6 ]), _createElementVNode("span", {
                    class: _normalizeClass(_ctx.$style.headerRightButtonText)
                  }, _toDisplayString(targetChannel.value.name), 3 /* TEXT, CLASS */) ])) ], 64 /* STABLE_FRAGMENT */)) : _createCommentVNode("v-if", true), (visibility.value !== 'specified') ? (_openBlock(), _createElementBlock("button", {
              key: 0,
          ...
          }, [ _hoisted_9 ], 2 /* CLASS */), _createElementVNode("button", {
            ref: submitButtonEl,
            ...
            onClick: post
              ...
              }, null, 2 /* CLASS */) ], 2 /* CLASS */) ], 10 /* CLASS, PROPS */, ["disabled"]) ], 2 /* CLASS */) ], 2 /* CLASS */), (replyTargetNote.value) ? (_openBlock(), _createBlock(MkNoteSimple, {
          key: 0,
          class: _normalizeClass(_ctx.$style.targetNote),
          note: replyTargetNote.value
        })) : _createCommentVNode("v-if", true), (renoteTargetNote.value) ? (_openBlock(), _createBlock(MkNoteSimple, {
          key: 0,
          class: _normalizeClass(_ctx.$style.targetNote),
          note: renoteTargetNote.value
        })) : _createCommentVNode("v-if", true), (quoteId.value) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: _normalizeClass(_ctx.$style.withQuote)
            ...
            onClick: _cache[0] || (_cache[0] = ($event: any) => { quoteId = null; renoteTargetNote = null; })
          ...
          class: _normalizeClass(_ctx.$style.toSpecified)
            ...
            class: _normalizeClass(_ctx.$style.visibleUsers)
              ...
              return (_openBlock(), _createElementBlock("span", {
                ...
                _createVNode(_component_MkAcct, { user: u }),
            ...
            }, [ _hoisted_14 ]) ], 2 /* CLASS */) ])) : _createCommentVNode("v-if", true), (!_unref(store).r.tips.value.postForm) ? (_openBlock(), _createBlock(MkInfo, {
          key: 0,
        ...
        }, null, 42 /* CLASS, PROPS, NEED_HYDRATION */, ["placeholder"]), [ [_vModelText, cw.value] ]), (maxCwTextLength - cwTextLength.value < 20) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            class: _normalizeClass(['_acrylic', _ctx.$style.cwTextCount, { [_ctx.$style.cwTextOver]: cwTextLength.value > maxCwTextLength }])
          }, _toDisplayString(maxCwTextLength - cwTextLength.value), 1 /* TEXT */)) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), [ [_vShow, useCw.value] ]), _createElementVNode("div", {
        class: _normalizeClass([_ctx.$style.textOuter, { [_ctx.$style.withCw]: useCw.value }])
          ...
          onCompositionend: onCompositionEnd
        }, null, 42 /* CLASS, PROPS, NEED_HYDRATION */, ["disabled", "readonly", "placeholder"]), [ [_vModelText, text.value] ]), (maxTextLength.value - textLength.value < 100) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
        ...
        list: "hashtags"
      }, null, 10 /* CLASS, PROPS */, ["placeholder"]), [ [_vModelText, _unref(hashtags)] ]), _createVNode(XPostFormAttaches, {
        onDetach: detachFile,
        ...
        "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event: any) => ((files).value = $event))
      }), (_unref(uploader).items.value.length > 0) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          style: "padding: 12px;"
          ...
          }) ])) : _createCommentVNode("v-if", true), (poll.value) ? (_openBlock(), _createBlock(MkPollEditor, {
          key: 0,
        ...
        })) : _createCommentVNode("v-if", true), (showPreview.value) ? (_openBlock(), _createBlock(MkNotePreview, {
          key: 0,
        ...
        })) : _createCommentVNode("v-if", true), (showingOptions.value) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
        ...
        class: _normalizeClass(_ctx.$style.footer)
          ...
          class: _normalizeClass(_ctx.$style.footerLeft)
          ...
          }, [ _hoisted_15 ], 2 /* CLASS */), _createElementVNode("button", {
            class: _normalizeClass(["_button", _ctx.$style.footerButton]),
            onClick: chooseFileFromDrive
          }, [ _hoisted_16 ], 2 /* CLASS */), _createElementVNode("button", {
            ...
            onClick: insertMention
          }, [ _hoisted_20 ], 2 /* CLASS */), (showAddMfmFunction.value) ? (_openBlock(), _createElementBlock("button", {
              key: 0,
              class: _normalizeClass(['_button', _ctx.$style.footerButton]),
              ...
              class: _normalizeClass(["_button", _ctx.$style.footerButton]),
              onClick: showActions
            }, [ _hoisted_22 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), _createElementVNode("div", {
          class: _normalizeClass(_ctx.$style.footerRight)
        }, [ _createElementVNode("button", {
            class: _normalizeClass(['_button', _ctx.$style.footerButton]),
            onClick: insertEmoji
          }, [ _hoisted_23 ], 2 /* CLASS */) ], 2 /* CLASS */) ], 2 /* CLASS */), _createElementVNode("datalist", { id: "hashtags" }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(recentHashtags.value, (hashtag) => {
