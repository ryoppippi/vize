...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    pinned: { type: Boolean as PropType<boolean>, required: false },
    mock: { type: Boolean as PropType<boolean>, required: false, default: false },
    withHardMute: { type: Boolean as PropType<boolean>, required: false }
  },
  ...
  return (!hardMuted.value && !hideByPlugin.value && muted.value === false)
      ? (_openBlock(), _createElementBlock("div", {
        ...
        tabindex: "0"
          ...
          })) : _createCommentVNode("v-if", true), (__props.pinned) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            ...
            class: _normalizeClass(_ctx.$style.renote)
              ...
              link: "",
              preview: ""
            }), _hoisted_2, _createVNode(_component_I18n, {
              ...
              class: _normalizeClass(_ctx.$style.renoteInfo)
                ...
                }, null, 2 /* CLASS */), _createVNode(_component_MkTime, { time: _unref(note).createdAt }) ], 34 /* CLASS, NEED_HYDRATION */), (_unref(note).visibility !== 'public') ? (_openBlock(), _createElementBlock("span", {
                  key: 0,
                ...
                }, [ _hoisted_4 ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ])) : _createCommentVNode("v-if", true), (_unref(isRenote) && _unref(note).renote == null) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            class: _normalizeClass(_ctx.$style.deleted)
          }, "\n\t\t" + _toDisplayString(_unref(i18n).ts.deletedNote) + "\n\t", 1 /* TEXT */)) : (renoteCollapsed.value) ? (_openBlock(), _createElementBlock("div", {
              key: 1,
            ...
            onContextmenu: _withModifiers(onContextmenu, ["stop"])
              ...
              class: _normalizeClass(_ctx.$style.main)
                ...
                mini: true
              }), (_unref(showTicker)) ? (_openBlock(), _createBlock(MkInstanceTicker, {
                  key: 0,
                  host: _unref(appearNote).user.host,
                  instance: _unref(appearNote).user.instance
                })) : _createCommentVNode("v-if", true), _createElementVNode("div", { style: "container-type: inline-size;" }, [ (_unref(appearNote).cw != null) ? (_openBlock(), _createElementBlock("p", {
                    key: 0,
                  ...
                  class: _normalizeClass([{ [_ctx.$style.contentCollapsed]: collapsed.value }])
                    ...
                    class: _normalizeClass(_ctx.$style.text)
                        ...
                        enableEmojiMenuReaction: true,
                        class: "_selectable"
                      })) : _createCommentVNode("v-if", true), (translating.value || translation.value) ? (_openBlock(), _createElementBlock("div", {
                        key: 0,
                        class: _normalizeClass(_ctx.$style.translation)
                            ...
                            mini: ""
                                ...
                                emojiUrls: _unref(appearNote).emojis,
                                class: "_selectable"
                              }) ])) : _createCommentVNode("v-if", true) ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), (_unref(appearNote).files && _unref(appearNote).files.length > 0) ? (_openBlock(), _createElementBlock("div", {
                      key: 0,
                      ...
                      class: _normalizeClass(_ctx.$style.poll)
                    })) : _createCommentVNode("v-if", true), (_unref(isEnabledUrlPreview)) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(urls.value, (url) => {
                        ...
                        }, null, 10 /* CLASS, PROPS */, ["url", "compact", "detail"]))
                      ...
                      onClick: _cache[3] || (_cache[3] = ($event: any) => (collapsed.value = false))
                        ...
                        }, _toDisplayString(_unref(i18n).ts.showLess), 3 /* TEXT, CLASS */) ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */), [ [_vShow, _unref(appearNote).cw == null || showContent.value] ]), (_unref(appearNote).channel && !inChannel) ? (_openBlock(), _createBlock(_component_MkA, {
                    key: 0,
                    ...
                    _: 1 /* STABLE */
                  })) : _createCommentVNode("v-if", true) ]), (_unref(appearNote).reactionAcceptance !== 'likeOnly') ? (_openBlock(), _createBlock(MkReactionsViewer, {
                  key: 0,
                ...
                }, [ _hoisted_11 ], 34 /* CLASS, NEED_HYDRATION */) ], 2 /* CLASS */) ], 2 /* CLASS */) ])) ]))
      : (!hardMuted.value && !hideByPlugin.value)
        ? (_openBlock(), _createElementBlock("div", {
          ...
          onClick: _cache[10] || (_cache[10] = ($event: any) => (muted.value = false))
              ...
              _: 1 /* STABLE */
            })) : (showSoftWordMutedWord.value !== true) ? (_openBlock(), _createBlock(_component_I18n, {
                key: 1,
                ...
                _: 1 /* STABLE */
              })) : (_openBlock(), _createBlock(_component_I18n, {
              key: 2,
