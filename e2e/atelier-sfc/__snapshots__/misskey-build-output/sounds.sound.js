...
export default /*@__PURE__*/_defineComponent({
  __name: 'sounds.sound',
  props: {
    def: { type: null as unknown as PropType<SoundStore>, required: true }
  },
  emits: ["update"],
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", { class: "_gaps_m" }, [ _createVNode(MkSelect, {
        ...
        _: 1 /* STABLE */
      }), (_unref(type) === '_driveFile_' && driveFileError.value === true) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: _normalizeClass(_ctx.$style.fileSelectorRoot)
            ...
            class: _normalizeClass(_ctx.$style.fileErrorRoot)
              ...
              _: 1 /* STABLE */
            }) ], 2 /* CLASS */) ])) : (_unref(type) === '_driveFile_') ? (_openBlock(), _createElementBlock("div", {
            key: 1,
            class: _normalizeClass(_ctx.$style.fileSelectorRoot)
          }, [ _createVNode(MkButton, {
              class: _normalizeClass(_ctx.$style.fileSelectorButton),
