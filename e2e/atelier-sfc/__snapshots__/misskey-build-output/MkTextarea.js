...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    mfmPreview: { type: Boolean as PropType<boolean>, required: false },
    ...
    code: { type: Boolean as PropType<boolean>, required: false },
    tall: { type: Boolean as PropType<boolean>, required: false },
    pre: { type: Boolean as PropType<boolean>, required: false }
  },
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", { class: "_selectable" }, [ _createElementVNode("div", {
      ...
      }, [ _renderSlot(_ctx.$slots, "caption") ], 2 /* CLASS */), (__props.mfmPreview) ? (_openBlock(), _createElementBlock("button", {
          key: 0,
        ...
        }, [ _createVNode(_component_Mfm, { text: v.value }) ])) : _createCommentVNode("v-if", true), (__props.manualSave && changed.value) ? (_openBlock(), _createBlock(MkButton, {
          key: 0,
          primary: "",
