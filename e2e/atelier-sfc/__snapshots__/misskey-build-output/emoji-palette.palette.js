...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    palette: { type: Object as PropType<{ id: string; name: string; emojis: string[]; }>, required: true }
  },
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createBlock(MkFolder, { defaultOpen: true }, {
  	...
  	emoji
          ...
          }, _toDisplayString(_unref(i18n).ts.reactionSettingDescription2), 3 /* TEXT, CLASS */)
        ])
      ]),
      _: 1 /* STABLE */
    }, 8 /* PROPS */, ["defaultOpen"]))
