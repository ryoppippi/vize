            ...
            (tab.value === 'overview')
              ? (_openBlock(), _createElementBlock("div", {
                ...
                _createElementVNode("div", {
                  ...
                  }, _toDisplayString(instance.value.name || `(${_unref(i18n).ts.unknown})`), 3 /* TEXT, CLASS */)
                ], 2 /* CLASS */),
                  ...
                  ? (_openBlock(), _createBlock(FormSection, { key: 0 }, {
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("div", { class: "_gaps_s" }, [
                        _createVNode(MkKeyValue, null, {
                          key: _withCtx(() => [
                            _createTextVNode("\n\t\t\t\t\t\t\t" + _toDisplayString(_unref(i18n).ts._delivery.status) + "\n\t\t\t\t\t\t", 1 /* TEXT */)
                          ]),
                          value: _withCtx(() => [
                            _createTextVNode("\n\t\t\t\t\t\t\t" + _toDisplayString(_unref(i18n).ts._delivery._type[suspensionState.value]) + "\n\t\t\t\t\t\t", 1 /* TEXT */)
                          ]),
                          _: 1 /* STABLE */
                        }),
                        (suspensionState.value === 'none')
                ...
                ? (_openBlock(), _createElementBlock("div", {
                  ...
                  _createElementVNode("div", null, [
                    ...
                    _createElementVNode("div", null, [
                      ...
                      }, _toDisplayString(_unref(i18n).tsx.recentNHours({ n: 90 })), 3 /* TEXT, CLASS */),
                      ...
                      _createElementVNode("div", {
                        class: _normalizeClass(_ctx.$style.label)
                      }, _toDisplayString(_unref(i18n).tsx.recentNDays({ n: 90 })), 3 /* TEXT, CLASS */),
                      _createVNode(MkChart, {
                        src: _unref(chartSrc),
                        span: "day",
                        limit: 90,
