...
import { emptyStrToEmptyArray, emptyStrToNull, emptyStrToUndefined, roleIdsParser } from '@/pages/admin/custom-emojis-manager.impl.js'
...
export default /*@__PURE__*/_defineComponent({
  __name: 'custom-emojis-manager.local.list',
  setup(__props) {
  ...
  return (_openBlock(), _createBlock(_component_MkStickyContainer, null, {
      header: _withCtx(() => [
        _createVNode(_component_MkPageHeader, {
          overridePageMetadata: headerPageMetadata.value,
          actions: headerActions.value
        })
      ]),
      default: _withCtx(() => [
        _createElementVNode("div", {
          class: _normalizeClass(["_gaps", _ctx.$style.main])
        }, [
        ...
        (gridItems.value.length > 0)
          ? (_openBlock(), _createElementBlock("div", {
            ...
            _createElementVNode("div", {
              ...
              _createVNode(MkButton, {
                ...
                default: _withCtx(() => [
                  ...
                  _createTextVNode(" ("),
                  _createTextVNode(_toDisplayString(deleteItemsCount.value), 1 /* TEXT */),
                  _createTextVNode(")\n\t\t\t\t")
                ]),
                _: 1 /* STABLE */
              })
            ...
            _createElementVNode("div", {
              ...
              _createVNode(MkButton, {
                primary: "",
                disabled: updateButtonDisabled.value,
                ...
                default: _withCtx(() => [
                  ...
                  _createTextVNode(" ("),
                  _createTextVNode(_toDisplayString(updatedItemsCount.value), 1 /* TEXT */),
                  _createTextVNode(")\n\t\t\t\t")
                ]),
                _: 1 /* STABLE */
              }),
              _createVNode(MkButton, { onClick: onGridResetButtonClicked }, {
                default: _withCtx(() => [
