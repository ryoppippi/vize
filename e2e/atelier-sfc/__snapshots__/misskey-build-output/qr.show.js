          ...
          class: _normalizeClass(_ctx.$style.user)
            ...
            indicator: false
              ...
              class: _normalizeClass(_ctx.$style.name)
                ...
                _: 1 /* STABLE */
              }) ], 2 /* CLASS */), _createElementVNode("div", null, [ _createVNode(_component_MkCondensedLine, { minScale: 2 / 3 }, {
                default: _withCtx(() => [
                  _createTextVNode(_toDisplayString(acct.value), 1 /* TEXT */)
                ]),
                _: 1 /* STABLE */
              }) ]) ]) ], 2 /* CLASS */), (_unref(deviceMotionPermissionNeeded)) ? (_openBlock(), _createElementBlock("img", {
            key: 0,
