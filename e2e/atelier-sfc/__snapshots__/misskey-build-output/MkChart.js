...
import { openBlock as _openBlock, createElementBlock as _createElementBlock, createVNode as _createVNode, createElementVNode as _createElementVNode, createCommentVNode as _createCommentVNode, resolveComponent as _resolveComponent, normalizeClass as _normalizeClass } from "vue"
...
export default /*@__PURE__*/_defineComponent({
  __name: 'MkChart',
  props: {
    src: { type: null as unknown as PropType<ChartSrc>, required: true },
    args: { type: Object as PropType<{ host?: string; user?: Misskey.entities.UserLite; withoutAll?: boolean; }>, required: false, default: undefined },
    limit: { type: Number as PropType<number>, required: false, default: 90 },
    span: { type: String as PropType<'hour' | 'day'>, required: true },
    detailed: { type: Boolean as PropType<boolean>, required: false, default: false },
    stacked: { type: Boolean as PropType<boolean>, required: false, default: false },
    bar: { type: Boolean as PropType<boolean>, required: false, default: false },
    aspectRatio: { type: Number as PropType<number | null>, required: false, default: null },
    nowForChromatic: { type: Number as PropType<number>, required: false }
  },
  setup(__props) {
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      }), (fetching.value) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: _normalizeClass(_ctx.$style.fetching)
