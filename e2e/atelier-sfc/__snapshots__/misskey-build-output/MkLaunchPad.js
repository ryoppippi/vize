...
const _hoisted_1 = { class: "text", "data-v-4d225969": "" }
const _hoisted_2 = /*#__PURE__*/ _createElementVNode("i", { class: "_indicatorCircle", "data-v-4d225969": "" })
const _hoisted_3 = { class: "text", "data-v-4d225969": "" }
const _hoisted_4 = /*#__PURE__*/ _createElementVNode("i", { class: "_indicatorCircle", "data-v-4d225969": "" })
...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    anchor: { type: Object as PropType<{ x: string; y: string; }>, required: false, default: () => ({ x: 'right', y: 'center' }) }
  },
  emits: ["closed"],
  ...
  return (_openBlock(), _createBlock(MkModal, {
      ...
      default: _withCtx(({ type, maxHeight }) => [
        _createElementVNode("div", {
          ...
          style: _normalizeStyle({ maxHeight: maxHeight ? maxHeight + 'px' : '' }),
          "data-v-4d225969": ""
        }, [
          _createElementVNode("div", {
            class: "main",
            ...
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_unref(items), (item) => {
              return (_openBlock(), _createElementBlock(_Fragment, { key: item.text, "data-v-4d225969": "" }, [
                (item.action != null)
