...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    modelValue: { type: Array as PropType<Misskey.entities.DriveFile[]>, required: true },
    detachMediaFn: { type: Object as PropType<(id: string) => void>, required: false }
  },
...
return (_ctx: any,_cache: any) => {
  return _withDirectives((_openBlock(), _createElementBlock("div", {
      ...
      }, "\n\t\t" + _toDisplayString(props.modelValue.length) + "/16\n\t", 3 /* TEXT, CLASS */) ], 2 /* CLASS */)), [ [_vShow, props.modelValue.length != 0] ])
}
}
