...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    scheduled: { type: Boolean as PropType<boolean>, required: false }
  },
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createBlock(MkModalWindow, {
      ...
      header: _withCtx(() => [
        _createTextVNode("\n\t\t" + _toDisplayString(_unref(i18n).ts.draftsAndScheduledNotes) + " (" + _toDisplayString(currentDraftsCount.value) + "/" + _toDisplayString(_unref($i)?.policies.noteDraftLimit) + ")\n\t", 1 /* TEXT */)
      ]),
      default: _withCtx(() => [
