...
const _hoisted_1 = /*#__PURE__*/ _createElementVNode("img", { src: "/client-assets/testcaptcha.png", style: "width: 60px; height: 60px; " })
...
export default /*@__PURE__*/_defineComponent({
  __name: 'MkCaptcha',
  props: {
    provider: { type: null as unknown as PropType<CaptchaProvider>, required: true },
    sitekey: { type: String as PropType<string | null>, required: true },
    secretKey: { type: String as PropType<string | null>, required: false },
    instanceUrl: { type: String as PropType<string | null>, required: false },
    modelValue: { type: String as PropType<string | null>, required: false }
  },
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", null, [ (!available.value) ? (_openBlock(), _createElementBlock("span", { key: 0 }, [ _createTextVNode("Loading"), _createVNode(_component_MkEllipsis) ])) : _createCommentVNode("v-if", true), (props.provider == 'mcaptcha') ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ (mCaptchaIframeUrl.value != null) ? (_openBlock(), _createElementBlock("iframe", {
              key: 0,
              ref: "mCaptchaIframe",
              src: mCaptchaIframeUrl.value,
              style: "border: none; max-width: 320px; width: 100%; height: 100%; max-height: 80px;"
            })) : _createCommentVNode("v-if", true) ])) : _createCommentVNode("v-if", true), (props.provider == 'testcaptcha') ? (_openBlock(), _createElementBlock("div", {
          key: 0,
        ...
        }, [ _hoisted_1, (testcaptchaPassed.value) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _hoisted_2 ])) : (_openBlock(), _createElementBlock("div", { key: 1 }, [ _hoisted_3, _withDirectives(_createElementVNode("input", {
                "onUpdate:modelValue": [($event: any) => ((testcaptchaInput).value = $event), ($event: any) => ((testcaptchaInput).value = $event), ($event: any) => ((testcaptchaInput).value = $event)],
                "data-cy-testcaptcha-input": ""
              }, null, 512 /* NEED_PATCH */), [ [_vModelText, testcaptchaInput.value] ]), _createElementVNode("button", {
                type: "button",
                "data-cy-testcaptcha-submit": "",
                onClick: testcaptchaSubmit
              }, "Submit") ])) ])) : (_openBlock(), _createElementBlock("div", {
          key: 1,
          ref: "captchaEl"
        })) ]))
}
