...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      onKeydown: handleKeydown
        ...
        to: { name: '~username-orgs', params: { username: __props.username } },
        class: "link-subtle font-mono text-sm inline-flex items-center gap-1"
      }, {
        default: _withCtx(() => [
          _createTextVNode("\n      "),
          _createTextVNode(_toDisplayString(_ctx.$t('header.orgs')), 1 /* TEXT */),
          _createTextVNode("\n      "),
        ...
        default: _withCtx(() => [
          (isOpen.value)
            ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "absolute inset-ie-0 top-full pt-2 w-56 z-50"
            }, [
              _createElementVNode("div", { class: "bg-bg-elevated border border-border rounded-lg shadow-lg overflow-hidden" }, [
                _createElementVNode("div", { class: "px-3 py-2 border-b border-border" }, [
                  _createElementVNode("span", _hoisted_1, _toDisplayString(_ctx.$t('header.orgs_dropdown.title')), 1 /* TEXT */)
                ]),
                (isLoading.value)
                  ? (_openBlock(), _createElementBlock("div", {
                    key: 0,
                    ...
                    _createElementVNode("span", _hoisted_2, _toDisplayString(_ctx.$t('header.orgs_dropdown.loading')), 1 /* TEXT */)
                  ]))
                  : (error.value)
                    ? (_openBlock(), _createElementBlock("div", {
                      key: 1,
                      ...
                      _createElementVNode("span", _hoisted_3, _toDisplayString(_ctx.$t('header.orgs_dropdown.error')), 1 /* TEXT */)
                    ]))
                  : (orgs.value.length > 0)
                    ? (_openBlock(), _createElementBlock("ul", {
                      ...
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(orgs.value, (org) => {
                        return (_openBlock(), _createElementBlock("li", { key: org }, [
                          _createVNode(_component_NuxtLink, {
                            ...
                            default: _withCtx(() => [
                              _createTextVNode("\n                @"),
                              _createTextVNode(_toDisplayString(org), 1 /* TEXT */),
                              _createTextVNode("\n              ")
                            ]),
                            _: 1 /* STABLE */
                          })
                  ...
                  : (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("span", _hoisted_4, _toDisplayString(_ctx.$t('header.orgs_dropdown.empty')), 1 /* TEXT */)
                  ])),
                _createElementVNode("div", { class: "px-3 py-2 border-t border-border" }, [
                  _createVNode(_component_NuxtLink, {
                    ...
                    default: _withCtx(() => [
                      _createTextVNode("\n              "),
                      _createTextVNode(_toDisplayString(_ctx.$t('header.orgs_dropdown.view_all')), 1 /* TEXT */),
                      _createTextVNode("\n              "),
                      _hoisted_5
                    ]),
                    _: 1 /* STABLE */
