...
return (_ctx: any,_cache: any) => {
  return (_openBlock(), _createBlock(VFSection, {
      id: _unref(HOME_HEADING_ID).volunteer,
      title: _unref(t)('volunteer.title'),
      "cover-image": {
        src: _unref(bp) === 'pc'
          ? _unref(withBase)('/images/top/cover/volunteer-pc.svg')
          : _unref(withBase)('/images/top/cover/volunteer-sp.svg'),
        alt: _unref(t)('volunteer.coverImageAlt'),
      }
    }, {
      default: _withCtx(() => [
        _createVNode(_resolveDynamicComponent(_unref(locale) === 'ja' ? _unref(JaVolunteer) : _unref(EnVolunteer)))
      ]),
      _: 1 /* STABLE */
