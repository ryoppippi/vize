  ...
  <div class="glyph-playground">
      ...
      <div class="panel-header">
        <div class="header-title">
          <svg class="icon" viewBox="0 0 24 24">
            <path fill="currentColor" :d="mdiFileEdit" />
          </svg>
          <h2>
            Source
          </h2>
        ...
        <div class="panel-actions">
          <button class="btn-ghost" @click="source = GLYPH_PRESET">
            Reset
          </button>
    ...
    <div class="panel output-panel">
      <div class="panel-header">
        <div class="header-title">
          <svg class="icon" viewBox="0 0 24 24">
            <path fill="currentColor" :d="mdiAutoFix" />
          </svg>
          <h2>
            Code Formatting
          </h2>
              ...
              <div class="options-section">
                ...
                <div class="toggle-grid">
                  ...
                  <div class="toggle-card">
                    ...
                    <span class="toggle-desc">
                      Put closing bracket on the same line
                    </span>
                  </div>
                  <div class="toggle-card">
                    <div class="toggle-main">
              ...
              <div class="options-section">
                ...
                <div class="toggle-grid" style="margin-bottom: 0.75rem">
                  <div class="toggle-card">
                    ...
                    <span class="toggle-desc">
                      Reorder blocks: script → setup → template → style
                    </span>
                  </div>
                </div>
                <div class="options-grid">
                  <div class="option-card">
                    ...
                    <span class="option-desc">
                      How to sort attributes within priority groups
                    </span>
                  </div>
                  <div class="option-card">
                    <div class="option-header">
      ...
      ($event.target as HTMLInputElement).value === "
                    ...
                    <span class="option-desc">
                      Max attributes per line before wrapping
                    </span>
                  </div>
                </div>
                <div class="toggle-grid" style="margin-top: 0.75rem">
                  ...
                  <div class="toggle-card">
                    ...
                    <span class="toggle-desc">
                      Normalize v-bind/v-on/v-slot to shorthand
                    </span>
                  </div>
                  <div class="toggle-card">
                    <div class="toggle-main">
                    ...
                    <span class="toggle-desc">
                      Enforce single attribute per line in templates
                    </span>
                  </div>
                  <div class="toggle-card">
                    <div class="toggle-main">
